...
img = double(imread('TomAndJerry_512x512.png'))/255;
%img = img(141:140+256, 51:50+256);
%msk = zeros(size(img));
%msk(65:192,65:192) = imresize(imread('TomAndJerry_512x512_mask.png'), 0.5);
msk = imread('TomAndJerry_512x512_mask.png');
img_corrupted = img;
img_corrupted(~msk) = 0;
