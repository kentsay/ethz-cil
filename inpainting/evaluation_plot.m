...
gd_rmd = load('gradients_randmask.mat');
gd_txt = load('gradients_textmask.mat');
% SVD
...
semilogy(x, dct_rmd.Result_Mean,'--gp', ...
     ...
     x, df_gau_rmd.Result_Mean, '--ko', ...
     x, gd_rmd.Result_Mean,     '--m*');
legend('DCT', ...
       'SVD', ...
       'Haar wavelet', ...
       'Diffusion diamond', ...
...
semilogy(x, dct_rmd.Time_Mean,    '--gp', ...
     ...
     x, df_gau_rmd.Time_Mean, '--ko', ...
     x, gd_rmd.Time_Mean,     '--m*');
legend('DCT', ...
       'SVD', ...
       'Haar wavelet' , ...
       'Diffusion diamond', ...
